...
- The two layers are `business` and `application`, analogous to "Silver" and "Gold" respectively. - The SQL scripts are named after the View to be created in Dremio.
- Each script is accompanied with a .txt or .md prefixed with `wiki_`, which contains the Wiki information to be used in the Dremio semantic layer.
